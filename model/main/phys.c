...
static void StoreEnergyVariables(gridT *grid, physT *phys, propT *prop);
static void AverageEnergyVariables(gridT *grid, physT *phys, propT *prop);
static void StoreEnergyVariablesDecompose(gridT *grid, physT *phys, propT *prop);
static void AverageEnergyVariablesDecompose(gridT *grid, physT *phys, propT *prop);
...
void AllocatePhysicalVariables(gridT *grid, physT **phys, propT *prop)
{
  ...
  *phys = (physT *)SunMalloc(sizeof(physT),"AllocatePhysicalVariables");
  ...
  // allocate variables for pressures
  if(prop->bottomPressure){
    (*phys)->p_prime =(REAL **)SunMalloc(Nc*sizeof(REAL *),"AllocatePhysicalVariables");
    for(i=0;i<Nc;i++) {
      (*phys)->p_prime[i] = (REAL *)SunMalloc(grid->Nk[i]*sizeof(REAL),"AllocatePhysicalVariables");
    }
    (*phys)->p_hyd =(REAL **)SunMalloc(Nc*sizeof(REAL *),"AllocatePhysicalVariables");
    for(i=0;i<Nc;i++) {
      (*phys)->p_hyd[i] = (REAL *)SunMalloc(grid->Nk[i]*sizeof(REAL),"AllocatePhysicalVariables");
    }
  }

  // allocate variables for energy budget
  if(prop->computeEnergy){
    // conversion term
    if(prop->C_zdependent){
      (*phys)->C1tmp_ =(REAL **)SunMalloc(Nc*sizeof(REAL *),"AllocatePhysicalVariables");
      (*phys)->C2tmp_ = (REAL **)SunMalloc(Nc*sizeof(REAL *),"AllocatePhysicalVariables");
      (*phys)->C1_ = (REAL **)SunMalloc(Nc*sizeof(REAL *),"AllocatePhysicalVariables");
      (*phys)->C2_ = (REAL **)SunMalloc(Nc*sizeof(REAL *),"AllocatePhysicalVariables");
      (*phys)->C1_int_ = (REAL **)SunMalloc(Nc*sizeof(REAL *),"AllocatePhysicalVariables");
      (*phys)->C2_int_ = (REAL **)SunMalloc(Nc*sizeof(REAL *),"AllocatePhysicalVariables"); 
      for(i=0;i<Nc;i++) {
        (*phys)->C1tmp_[i] = (REAL *)SunMalloc(grid->Nk[i]*sizeof(REAL),"AllocatePhysicalVariables");
        (*phys)->C2tmp_[i] = (REAL *)SunMalloc(grid->Nk[i]*sizeof(REAL),"AllocatePhysicalVariables");
        (*phys)->C1_[i] = (REAL *)SunMalloc(grid->Nk[i]*sizeof(REAL),"AllocatePhysicalVariables");
        (*phys)->C2_[i] = (REAL *)SunMalloc(grid->Nk[i]*sizeof(REAL),"AllocatePhysicalVariables");
        (*phys)->C1_int_[i] = (REAL *)SunMalloc(grid->Nk[i]*sizeof(REAL),"AllocatePhysicalVariables");
        (*phys)->C2_int_[i] = (REAL *)SunMalloc(grid->Nk[i]*sizeof(REAL),"AllocatePhysicalVariables");
      }
    }
    (*phys)->C1tmp = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
    (*phys)->C2tmp = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
    (*phys)->C1 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
    (*phys)->C2 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
    (*phys)->C1_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
    (*phys)->C2_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
    // energy difference term
    (*phys)->dEk0 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
    (*phys)->dEp0 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
    (*phys)->dEk_prime = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
    (*phys)->dEp_prime = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
    // bottom drag term
    (*phys)->Dtmp1 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
    (*phys)->Dtmp2 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
    (*phys)->D_0 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
    (*phys)->D_prime = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
    (*phys)->D_0_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
    (*phys)->D_prime_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");

    if(prop->energyfluxCombine){
      (*phys)->F1tmp = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->F2tmp = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->F3tmp = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->F4tmp = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      // energy flux term
      (*phys)->Fx_0 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fy_0 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fx_prime = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fy_prime = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fx_0_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fy_0_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fx_prime_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fy_prime_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
    }else{
      (*phys)->F1tmp1 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->F1tmp2 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->F1tmp3 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->F1tmp4 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");

      (*phys)->F2tmp1 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->F2tmp2 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->F2tmp3 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->F2tmp4 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");

      (*phys)->F3tmp1 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->F3tmp2 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->F3tmp3 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->F3tmp4 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->F3tmp5 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");

      (*phys)->F4tmp1 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->F4tmp2 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->F4tmp3 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->F4tmp4 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->F4tmp5 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      // energy flux term
      (*phys)->Fx_01 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fx_02 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fx_03 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fx_04 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");

      (*phys)->Fy_01 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fy_02 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fy_03 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fy_04 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");

      (*phys)->Fx_prime1 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fx_prime2 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fx_prime3 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fx_prime4 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fx_prime5 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");

      (*phys)->Fy_prime1 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fy_prime2 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fy_prime3 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fy_prime4 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fy_prime5 = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");

      (*phys)->Fx_01_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fx_02_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fx_03_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fx_04_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");

      (*phys)->Fy_01_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fy_02_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fy_03_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fy_04_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");

      (*phys)->Fx_prime1_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fx_prime2_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fx_prime3_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fx_prime4_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fx_prime5_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");

      (*phys)->Fy_prime1_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fy_prime2_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fy_prime3_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fy_prime4_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
      (*phys)->Fy_prime5_int = (REAL *)SunMalloc(Nc*sizeof(REAL),"AllocatePhysicalVariables");
    }
  }
...
/*  for(i=0;i<Nc;i++) {
  ...
  */
  ...
  // Initiate variables for pressures
  if(prop->bottomPressure){
    for(i=0;i<grid->Nc;i++) {
      for(k=0;k<grid->Nk[i];k++) {
        phys->p_prime[i][k]=0;
  ...
  // Initiate variables for energy budget
  if(prop->computeEnergy){
    if(prop->C_zdependent){
      for(i=0;i<grid->Nc;i++) {
        for(k=0;k<grid->Nk[i];k++) {
    ...
    for(i=0;i<grid->Nc;i++) {
      ...
      if(prop->energyfluxCombine){
        ...
        phys->Fx_0_int[i]=0;
        phys->Fy_0_int[i]=0;
        phys->Fx_prime_int[i]=0;
        phys->Fy_prime_int[i]=0;
      }else{
        phys->F1tmp1[i]=0;
        phys->F1tmp2[i]=0;
        phys->F1tmp3[i]=0;
        ...
        phys->Fx_prime1_int[i]=0;
        phys->Fx_prime2_int[i]=0;
        phys->Fx_prime3_int[i]=0;
        phys->Fx_prime4_int[i]=0;
        phys->Fx_prime5_int[i]=0;

        phys->Fy_prime1_int[i]=0;
        phys->Fy_prime2_int[i]=0;
        phys->Fy_prime3_int[i]=0;
        phys->Fy_prime4_int[i]=0;
        phys->Fy_prime5_int[i]=0;
      }
    }
  }    
...
void Solve(gridT *grid, physT *phys, propT *prop, int myproc, int numprocs, MPI_Comm comm)
{
  ...
  // Initialise the energy arrays
  if(prop->computeEnergy){
    AllocateEnergyVariables(grid,&energy,prop);
    ZeroEnergyVariables(grid,energy,prop,comm);
  }
  ...
  for(n=prop->nstart+1;n<=prop->nsteps+prop->nstart;n++) {
    ...
    // Compute pressure
    if(prop->bottomPressure){
      OutputPressure(phys->p_prime, phys->p_hyd, energy,grid,phys,prop,comm);
    }

    // Compute energy budget
    if(prop->computeEnergy){
      if(prop->C_zdependent){
        Conversion_z(phys->C1_, phys->C2_, grid,energy,phys,prop,comm);
      }
      Conversion(phys->C1, phys->C2, grid,energy,phys,prop,comm);
      if(prop->energyfluxCombine){
        EnergyFlux(phys->Fx_0, phys->Fy_0, phys->Fx_prime, phys->Fy_prime, grid,energy,phys,prop,comm);
      }else{
        EnergyFluxDecompose(phys->Fx_01, phys->Fx_02, phys->Fx_03, phys->Fx_04, phys->Fy_01, phys->Fy_02, phys->Fy_03, phys->Fy_04, phys->Fx_prime1, phys->Fx_prime2, phys->Fx_prime3, phys->Fx_prime4, phys->Fx_prime5, phys->Fy_prime1, phys->Fy_prime2, phys->Fy_prime3, phys->Fy_prime4, phys->Fy_prime5, grid,energy,phys,prop,comm);
      }
      BottomDrag(phys->D_0, phys->D_prime, energy, grid, phys, prop, comm);
      EnergyDiff(energy, grid, phys, prop, comm);
      if(prop->energyfluxCombine){
        if(prop->n==1){
          StoreEnergyVariables(grid,phys,prop);
        }
        AverageEnergyVariables(grid,phys,prop);
        StoreEnergyVariables(grid,phys,prop);
      }else{
        if(prop->n==1){
          StoreEnergyVariablesDecompose(grid,phys,prop);
        }
        AverageEnergyVariablesDecompose(grid,phys,prop);
        StoreEnergyVariablesDecompose(grid,phys,prop);
      }
      // testinterp1(phys->Fx_0, phys->Fy_0, energy, grid, phys, prop);
    }
    ...
    if(prop->n >= prop->skipOutput){
      if (prop->outputNetcdf==0){
        ...
        // Output data to netcdf
      	if(prop->mergeArrays){
    	    WriteOutputNCmerge(prop, grid, phys, met, average,energy,blowup,numprocs,myproc,comm);
      	}else{
...
/*
 * Function: StoreEnergyVariables
 * Usage: StoreEnergyVariables(grid,phys);
 * ---------------------------------
 * Store the old values of Co into Cotmp
 *
 */
static void StoreEnergyVariables(gridT *grid, physT *phys, propT *prop) {
  int i, j, k, iptr, jptr;
  ...
  for(i=0;i<grid->Nc;i++) {
    if(prop->C_zdependent){
      for(k=0;k<grid->Nk[i];k++) {
        phys->C1tmp_[i][k]=phys->C1_[i][k];
        phys->C2tmp_[i][k]=phys->C2_[i][k];     
      }
    }

    phys->C1tmp[i]=phys->C1[i];
    phys->C2tmp[i]=phys->C2[i];

    phys->F1tmp[i]=phys->Fx_0[i];
    phys->F2tmp[i]=phys->Fy_0[i];
    phys->F3tmp[i]=phys->Fx_prime[i];
    phys->F4tmp[i]=phys->Fy_prime[i];
  }

}

/*
 * Function: StoreEnergyVariablesDecompose
 * Usage: StoreEnergyVariablesDecompose(grid,phys);
 * ---------------------------------
 * Store the old values of Co into Cotmp
 *
 */
static void StoreEnergyVariablesDecompose(gridT *grid, physT *phys, propT *prop) {
  ...
  for(i=0;i<grid->Nc;i++) {
    ...
    phys->F1tmp1[i]=phys->Fx_01[i];
    phys->F1tmp2[i]=phys->Fx_02[i];
    phys->F1tmp3[i]=phys->Fx_03[i];
    phys->F1tmp4[i]=phys->Fx_04[i];

    phys->F2tmp1[i]=phys->Fy_01[i];
    phys->F2tmp2[i]=phys->Fy_02[i];
    phys->F2tmp3[i]=phys->Fy_03[i];
    phys->F2tmp4[i]=phys->Fy_04[i];

    phys->F3tmp1[i]=phys->Fx_prime1[i];
    phys->F3tmp2[i]=phys->Fx_prime2[i];
    phys->F3tmp3[i]=phys->Fx_prime3[i];
    phys->F3tmp4[i]=phys->Fx_prime4[i];
    phys->F3tmp5[i]=phys->Fx_prime5[i];

    phys->F4tmp1[i]=phys->Fy_prime1[i];
    phys->F4tmp2[i]=phys->Fy_prime2[i];
    phys->F4tmp3[i]=phys->Fy_prime3[i];
    phys->F4tmp4[i]=phys->Fy_prime4[i];
    phys->F4tmp5[i]=phys->Fy_prime5[i];

    phys->Dtmp1[i]=phys->D_0[i];
    phys->Dtmp2[i]=phys->D_prime[i];
  }

}

/*
 * Function: AverageEnergyVariables
 * Usage: AverageEnergyVariables(grid,phys);
 * ---------------------------------
 * Average between the old and new values of Co
 *
 */
static void AverageEnergyVariablesDecompose(gridT *grid, physT *phys, propT *prop) {
  int i, j, k, iptr, jptr;
  ...
  for(i=0;i<grid->Nc;i++) {
    if(prop->C_zdependent){
      for(k=0;k<grid->Nk[i];k++) {
         phys->C1_int_[i][k]+=(phys->C1_[i][k]+phys->C1tmp_[i][k])/2*prop->dt;
         phys->C2_int_[i][k]+=(phys->C2_[i][k]+phys->C2tmp_[i][k])/2*prop->dt;
      }
    }
    phys->C1_int[i]+=(phys->C1[i]+phys->C1tmp[i])/2*prop->dt;
    phys->C2_int[i]+=(phys->C2[i]+phys->C2tmp[i])/2*prop->dt;

    phys->Fx_01_int[i]+=(phys->Fx_01[i]+phys->F1tmp1[i])/2*prop->dt;
    phys->Fx_02_int[i]+=(phys->Fx_02[i]+phys->F1tmp2[i])/2*prop->dt;
    phys->Fx_03_int[i]+=(phys->Fx_03[i]+phys->F1tmp3[i])/2*prop->dt;
    phys->Fx_04_int[i]+=(phys->Fx_04[i]+phys->F1tmp4[i])/2*prop->dt;

    phys->Fy_01_int[i]+=(phys->Fy_01[i]+phys->F2tmp1[i])/2*prop->dt;
    phys->Fy_02_int[i]+=(phys->Fy_02[i]+phys->F2tmp2[i])/2*prop->dt;
    phys->Fy_03_int[i]+=(phys->Fy_03[i]+phys->F2tmp3[i])/2*prop->dt;
    phys->Fy_04_int[i]+=(phys->Fy_04[i]+phys->F2tmp4[i])/2*prop->dt;

    phys->Fx_prime1_int[i]+=(phys->Fx_prime1[i]+phys->F3tmp1[i])/2*prop->dt;
    phys->Fx_prime2_int[i]+=(phys->Fx_prime2[i]+phys->F3tmp2[i])/2*prop->dt;
    phys->Fx_prime3_int[i]+=(phys->Fx_prime3[i]+phys->F3tmp3[i])/2*prop->dt;
    phys->Fx_prime4_int[i]+=(phys->Fx_prime4[i]+phys->F3tmp4[i])/2*prop->dt;
    phys->Fx_prime5_int[i]+=(phys->Fx_prime5[i]+phys->F3tmp5[i])/2*prop->dt;

    phys->Fy_prime1_int[i]+=(phys->Fy_prime1[i]+phys->F4tmp1[i])/2*prop->dt;
    phys->Fy_prime2_int[i]+=(phys->Fy_prime2[i]+phys->F4tmp2[i])/2*prop->dt;
    phys->Fy_prime3_int[i]+=(phys->Fy_prime3[i]+phys->F4tmp3[i])/2*prop->dt;
    phys->Fy_prime4_int[i]+=(phys->Fy_prime4[i]+phys->F4tmp4[i])/2*prop->dt;
    phys->Fy_prime5_int[i]+=(phys->Fy_prime5[i]+phys->F4tmp5[i])/2*prop->dt;

    phys->D_0_int[i]+=(phys->D_0[i]+phys->Dtmp1[i])/2*prop->dt;
    phys->D_prime_int[i]+=(phys->D_prime[i]+phys->Dtmp2[i])/2*prop->dt;
  }
...
static void AverageEnergyVariables(gridT *grid, physT *phys, propT *prop) {
  ...
  for(i=0;i<grid->Nc;i++) {
    ...
    phys->Fx_0_int[i]+=(phys->Fx_0[i]+phys->F1tmp[i])/2*prop->dt;
    phys->Fy_0_int[i]+=(phys->Fy_0[i]+phys->F2tmp[i])/2*prop->dt;
    phys->Fx_prime_int[i]+=(phys->Fx_prime[i]+phys->F3tmp[i])/2*prop->dt;
    phys->Fy_prime_int[i]+=(phys->Fy_prime[i]+phys->F4tmp[i])/2*prop->dt;
  }
...
{ 
  ...
  *prop = (propT *)SunMalloc(sizeof(propT),"ReadProperties");
  ...
  // addition for pressure
  (*prop)->bottomPressure = MPI_GetValue(DATAFILE,"bottomPressure","ReadProperties",myproc);
  // addition for energy budget
  (*prop)->computeEnergy = MPI_GetValue(DATAFILE,"computeEnergy","ReadProperties",myproc);
  (*prop)->C_zdependent = MPI_GetValue(DATAFILE,"C_zdependent","ReadProperties",myproc);
  // addition for shorter output nc file
  (*prop)->simpleout = MPI_GetValue(DATAFILE,"simpleout","ReadProperties",myproc);
  // addition for if output energy flux different terms
  (*prop)->energyfluxCombine = MPI_GetValue(DATAFILE,"energyfluxCombine","ReadProperties",myproc);
  ...
  if ((*prop)->netcdfBdy>0){
    (*prop)->nbc = (int)MPI_GetValue(DATAFILE,"nbc","ReadProperties",myproc);
    // addition for having more than 1 solitons as nc boundary condition
    (*prop)->nsolitons = (int)MPI_GetValue(DATAFILE,"nsolitons","ReadProperties",myproc);
    // time intervals between solitons, in hours
    (*prop)->dtsoliton = MPI_GetValue(DATAFILE,"dtsoliton","ReadProperties",myproc);
    // Time step for boundary conditions
    (*prop)->bc_dt = MPI_GetValue(DATAFILE,"bc_dt","ReadProperties",myproc);
  }
  ...
  if ((*prop)->wave_nesting>0){
    ...
    (*prop)->ramp_on = MPI_GetValue(DATAFILE,"ramp_on","ReadProperties",myproc);
  }else{
    (*prop)->Fhat_x = MPI_GetValue(DATAFILE,"Fhat_x","ReadProperties",myproc);
    (*prop)->Fhat_y = MPI_GetValue(DATAFILE,"Fhat_y","ReadProperties",myproc);
  }
